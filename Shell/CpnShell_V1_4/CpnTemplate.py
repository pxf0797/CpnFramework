...
class CpnTemplate:
    ...
    def creatSetDataTypeDeclaration(self):
        ...
        comments += (' * Only need to define the data sent, the transceiver interface uses a unified interface, no other definitions.\n')
