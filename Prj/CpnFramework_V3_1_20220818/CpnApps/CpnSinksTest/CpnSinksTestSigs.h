...
#define SIGNAL_SET_LIST_RTEASYN_CPNSINKSTEST(_)            \
    _(sig_set_CpnSinksTest_fetchData,sizeof(tStoreData))   \
...
#define SIGNAL_GET_MAP_LIST_RTEASYN_CPNSINKSTEST(_)        \
    _(sig_get_CpnSinksTest_wOutput,sig_set_CpnSourceTest_wOutput) \
    _(sig_get_CpnSinksTest_wCache,sig_set_CpnSinksTest_fetchData) \
