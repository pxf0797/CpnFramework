...
#define SIGNAL_SET_LEN_ADD_DEFINE(signal_set,len)               +signal_set##Len                                        /* Send signal length superposition. */
#define SIGNAL_SET_REGISTER(name,signal_set,len)                if(signal_set){name##SigSetIndex[signal_set] = (signal_set##Len+name##SigSetIndex[signal_set-1u]);}\
                                                                else{name##SigSetIndex[signal_set] = signal_set##Len;}  /* Send signal register in array. */
