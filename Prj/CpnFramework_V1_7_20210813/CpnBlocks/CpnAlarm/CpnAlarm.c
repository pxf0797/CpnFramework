...
htsEvents CpnAlarm_getAlarmEvents(hCpnAlarm cthis, teClassify classify, teSeriousLevel serious){
    ...
    if(cthis->alarmedEvents.events){
        clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarmedEvents.events);
    }
    if(cthis->alarmedEvents.upgradeNum){
        cthis->alarmedEvents.upgradeNum = 0u;
    }
    if(cthis->alarmedEvents.upgrades){
        clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarmedEvents.upgrades);
    }
    ...
    do{
        ...
        clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memMalloc, (uint8*)&tsMem);
        if(!tsMem.pointer){
 ...
 * Others   : CpnAlarm class function.
 **********************************************/
uint16 CpnAlarm_isAlarmed(hCpnAlarm cthis, uint16 event){
 ...
 * Others   : CpnAlarm class function.
 **********************************************/
uint16 CpnAlarm_isUpgraded(hCpnAlarm cthis, uint16 alarmUpIndex){
...
teAlarmCheckSta CpnAlarm_alarmSrcCheck(hCpnAlarm cthis, htsAlarm alarm){
    ...
    clRteAsynSigs.get(clRteAsynSigs.self, alarm->get_sig, (uint8*)&pGetData); /* get read data address */
    if(!pGetData){
...
void CpnAlarm_alarmCheckUpdate(hCpnAlarm cthis, htsAlarm alarm){
    ...
    clRteSynSigs.trig(clRteSynSigs.self, alarm->trig_sig, (uint8*)&ucCond); /* read precondition */
    if(!ucCond){
...
void CpnAlarm_err(hCpnAlarm cthis, uint16 code){
    uint32 uwErrCode = (((uint32)CPNALARMCFG_ERR_ID << 16) + code);
    clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_setErr, (uint8*)&uwErrCode);
}
...
void CpnAlarm_regist(hCpnAlarm cthis, htsAlarm alarm){
    ...
    memCopy(&cthis->alarms[cthis->alarmEventMax[SERIOUS_MAX_COUNT]], alarm, sizeof(tsAlarm));           /* regist */
...
void CpnAlarm_registUp(hCpnAlarm cthis, htsAlarmUp alarmUp){
    ...
    memCopy(&cthis->alarmUps[cthis->alarmUpEventMax], alarmUp, sizeof(tsAlarmUp));
...
uint16 CpnAlarm_dilatation(hCpnAlarm cthis){
    ...
    do{
        ...
        if(cthis->alarms){
            memCopy(tsMem.pointer,cthis->alarms,((cthis->buffEventMax-CPNALAEM_TYPE_WIDTH)*sizeof(tsAlarm)));
            clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarms);
        }
        ...
        if(cthis->alarmFlag){
            memCopy(tsMem.pointer,cthis->alarmFlag,((cthis->buffEventMax-CPNALAEM_TYPE_WIDTH)*sizeof(alarmType)));
            clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarmFlag);
        }
        ...
        if(cthis->alarmUpMask){
            memCopy(tsMem.pointer,cthis->alarmUpMask,((cthis->buffEventMax-CPNALAEM_TYPE_WIDTH)*sizeof(alarmType)));
            clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarmUpMask);
        }
        ...
        if(cthis->alarmTimer){
            memCopy(tsMem.pointer,cthis->alarmTimer,((cthis->buffEventMax-CPNALAEM_TYPE_WIDTH)*sizeof(uint32)));
            clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarmTimer);
        }
...
uint16 CpnAlarm_dilatationUp(hCpnAlarm cthis){
    ...
    do{
        ...
        if(cthis->alarmUps){
            memCopy(tsMem.pointer,cthis->alarmUps,((cthis->buffUpEventMax-CPNALAEM_TYPE_WIDTH)*sizeof(tsAlarmUp)));
            clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarmUps);
        }
        ...
        if(cthis->alarmUpFlag){
            memCopy(tsMem.pointer,cthis->alarmUpFlag,((cthis->buffUpEventMax-CPNALAEM_TYPE_WIDTH)*sizeof(alarmType)));
            clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarmUpFlag);
        }
        ...
        if(cthis->alarmUpTimer){
            memCopy(tsMem.pointer,cthis->alarmUpTimer,((cthis->buffUpEventMax-CPNALAEM_TYPE_WIDTH)*sizeof(uint32)));
            clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarmUpTimer);
        }
        ...
        if(cthis->alarmUpCounter){
            memCopy(tsMem.pointer,cthis->alarmUpCounter,((cthis->buffUpEventMax-CPNALAEM_TYPE_WIDTH)*sizeof(uint16)));
            clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_memFree, (uint8*)cthis->alarmUpCounter);
        }
