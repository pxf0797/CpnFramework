...
#include "../../CpnBasics/CpnInfo/CpnInfoCfg.h"
...
#define CPNFRAMEMATRIXCFG_FRAME_BYTES        8U    /* Frame byte length, usually 8£¬12£¬24£¬32£¬64bytes. 4*n bytes. */
...
#define FRAME_MATRIX_CFG_LIST(_)                                                \
    ...
    _(CPNINFOCFG_FRAME_ID, FRAME_TX, FF_MOTOROLA_LSB,    0U)                    \
...
#define FRAME_SET_SIG_LIST(_,...)                                               \
    ...
    _(ulInfoLow,          CPNINFOCFG_FRAME_ID, 24U, 32U,     __VA_ARGS__)       \
    _(ulInfoHigh,         CPNINFOCFG_FRAME_ID, 56U, 32U,     __VA_ARGS__)       \
