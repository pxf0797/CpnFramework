 ...
 * Others   :
 **********************************************/
void setFrameData(uint32 frame_data[], teFrameFormat format, uint16 bit_start, uint16 bit_len, uint32 value);
 ...
 * Others   :
 **********************************************/
void getFrameData(uint32 frame_data[], teFrameFormat format, uint16 bit_start, uint16 bit_len, uint32* value);
