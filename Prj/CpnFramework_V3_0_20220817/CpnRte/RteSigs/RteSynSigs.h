...
/* Synchronize macros.
 **********************************************/
#define SYN_TRIG(sig,hdata) clRteSynSigs.trig(clRteSynSigs.self, sig, (uint8 *)(hdata))
//#define SYN_SERV(sig,hdata) clRteSynSigs.serv(clRteSynSigs.self, sig, (uint8 *)(hdata))
