...
CL(BlockM){
    ...
    uint16 blockMMaskMaskMaskMax;       /* MaskMaskMask maximum counters. */
    uint16 blockMMaskMaskMax;           /* MaskMask maximum counters. */
    uint16 blockMMaskMax;               /* Mask maximum counters. */
    ...
    uint16 (*isIndexContinueSet)(hBlockM cthis, uint16 index);
    uint16 (*isFull)(hBlockM cthis);

    uint16 (*getSize)(hBlockM cthis, void *pointer); /* return o as abnormal. */
    uint16 (*getIndex)(hBlockM cthis, void *pointer); /* return blockMMax as abnormal. */
