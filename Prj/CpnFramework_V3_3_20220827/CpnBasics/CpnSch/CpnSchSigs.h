...
#define SIGNAL_SERV_LIST_RTESYN_CPNSCH(_)                                       \
    ...
    _(sig_serv_CpnSch_event,serv_CpnSch_event)                                  \
...
#define SIGNAL_TRIG_MAP_LIST_RTESYN_CPNSCH(_)                                   \
    ...
    _(sig_trig_CpnSch_event,sig_serv_CpnSch_event)                              \
    _(sig_trig_CpnSch_inf_getTime,sig_serv_Abi_getTime)                         \
    _(sig_trig_CpnSch_setErr,sig_serv_CpnErr_setErr)                            \
    _(sig_trig_CpnErr_init,sig_serv_CpnErr_init)                                \
    _(sig_trig_CpnMem_init,sig_serv_CpnMem_init)                                \
    _(sig_trig_CpnInfo_init,sig_serv_CpnInfo_init)                              \
    _(sig_trig_CpnSimple_init,sig_serv_CpnSimple_init)                          \
    ...
    _(sig_trig_CpnDataMana_init,sig_serv_CpnDataMana_init)                      \
    _(sig_trig_CpnAlarm_init,sig_serv_CpnAlarm_init)                            \
    _(sig_trig_CpnAlarmSource_init,sig_serv_CpnAlarmSource_init)                \
    _(sig_trig_CpnMemTest_init,sig_serv_CpnMemTest_init)                        \
    _(sig_trig_CpnFuncLibTest_init,sig_serv_CpnFuncLibTest_init)                \
    _(sig_trig_CpnDataManaTest_init,sig_serv_CpnDataManaTest_init)              \
