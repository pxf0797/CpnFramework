...
typedef enum {
    ...
    CPNSOURCECFG_ERR_ID,
    CPNCRCCFG_ERR_ID,
    CPNDATAMANACFG_ERR_ID,
    CPNALARMCFG_ERR_ID,
    CPNALARMSOURCECFG_ERR_ID,
    CPNMEMTESTCFG_ERR_ID,
    CPNFUNCLIBTESTCFG_ERR_ID,
    CPNDATAMANATESTCFG_ERR_ID,
    CPNTESTCFG_ERR_ID,
    CPNSINKSTESTCFG_ERR_ID,
    CPNSOURCETESTCFG_ERR_ID,
