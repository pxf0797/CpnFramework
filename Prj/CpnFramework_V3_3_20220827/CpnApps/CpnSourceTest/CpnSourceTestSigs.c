...
void serv_CpnSourceTest_init(void){
    ...
    if(OPRS(clCpnSourceTest) != NULL){
        ...
        SYN_TRIG(sig_trig_CpnSourceTest_initTask, &taskParam);
        ...
        wSine.duty = 500;
        wSine.phase = 900;
        SYN_TRIG(sig_trig_CpnSourceTest_registWaveSig, &wSine);
        wSine2.type = w_sine;
        ...
        wSine2.duty = 800;
        wSine2.phase = 1800;
        SYN_TRIG(sig_trig_CpnSourceTest_registWaveSig, &wSine2);
        wSine3.type = w_sine;
        ...
        wSine3.duty = 200;
        wSine3.phase = 2700;
        SYN_TRIG(sig_trig_CpnSourceTest_registWaveSig, &wSine3);
        ...
        wPluse.duty = 300;
        wPluse.phase = 300;
        SYN_TRIG(sig_trig_CpnSourceTest_registWaveSig, &wPluse);
        ...
        wPluse2.duty = 800;
        wPluse2.phase = 2100;
        SYN_TRIG(sig_trig_CpnSourceTest_registWaveSig, &wPluse2);
        ...
        wCountUp.duty = 800;
        wCountUp.phase = 2100;
        SYN_TRIG(sig_trig_CpnSourceTest_registWaveSig, &wCountUp);
        ...
        SYN_TRIG(sig_trig_CpnSourceTest_registWaveSig, &wCountDown);
        ...
        SYN_TRIG(sig_trig_CpnSourceTest_registWaveSig, &wCountUpDown);
    }
}
