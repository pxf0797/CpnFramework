...
void serv_CpnAlarmSource_init(void){
    ...
    taskParam.e.all = e_CpnSource;
    SYN_TRIG(sig_trig_CpnAlarmSource_initTask, &taskParam);
    ...
    SYN_TRIG(sig_trig_CpnAlarmSource_registWaveSig, &sSource[S_SINE]);
    ...
    SYN_TRIG(sig_trig_CpnAlarmSource_registWaveSig, &sSource[S_PLUSE]);
    ...
    SYN_TRIG(sig_trig_CpnAlarmSource_registWaveSig, &sSource[S_UPDOWN]);
    ...
    SYN_TRIG(sig_trig_CpnAlarmSource_registWaveSig, &sSource[S_UP]);
    ...
    SYN_TRIG(sig_trig_CpnAlarmSource_registWaveSig, &sSource[S_DOWN]);

    ASYN_SET(sig_set_CpnAlarmSource_sSine, &ulOutput[S_SINE]);
    ASYN_SET(sig_set_CpnAlarmSource_sPluse, &ulOutput[S_PLUSE]);
    ASYN_SET(sig_set_CpnAlarmSource_sUpDown, &ulOutput[S_UPDOWN]);
    ASYN_SET(sig_set_CpnAlarmSource_sUp, &ulOutput[S_UP]);
    ASYN_SET(sig_set_CpnAlarmSource_sDown, &ulOutput[S_DOWN]);
}
