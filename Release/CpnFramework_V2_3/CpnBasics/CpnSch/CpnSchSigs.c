...
void serv_CpnSch_init(void){
    CN(CpnSch, &clCpnSch, &SchSmRunRec, SchSm, trig_CpnSch_inf_getTime, trig_CpnSch_inf_initCpn);
...
void trig_CpnSch_inf_initCpn(void){
    ...
    clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnInfo_init, NULL);
    clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarm_init, NULL);
    clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnAlarmSource_init, NULL);
    clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnDataMana_init, NULL);
    clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnDataManaTest_init, NULL);
    clRteSynSigs.trig(clRteSynSigs.self, sig_trig_CpnFuncLibTest_init, NULL);
}
