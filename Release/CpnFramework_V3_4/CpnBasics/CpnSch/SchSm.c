...
void SchSm_act_update(void *SchSmRec){
    hSchSmRec hRec = (hSchSmRec)SchSmRec;
    taskGroupType taskMask = sig_clear;
    taskGroupType curTask = sig_clear;
    uint16 taskIndex = sig_clear;
    uint16 i = sig_clear;
    uint16 diffTick = sig_clear;
...
void SchSm_act_execute(void *SchSmRec){
    ...
    uint16 taskIndex = sig_clear;
    uint16 i = sig_clear;
    uint16 gotoUpdateFlag = sig_clear;
    static uint16 taskTimePot = sig_clear;
    static uint16 totalTimePot = sig_clear;
    uint16 specificFlag = sig_clear;
    uint16 currUsage = sig_clear;
