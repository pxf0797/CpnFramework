...
CL(CpnAlarm){
    ...
    uint8 (*isAlarmed)(hCpnAlarm cthis, uint16 event);            /* Event alram, TRUE/FALSE */
    uint8 (*isUpgraded)(hCpnAlarm cthis, uint16 alarmUpIndex);    /* Event alram upgrade, TRUE/FALSE */
