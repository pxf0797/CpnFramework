...
void CpnSinksTest_run(hCpnSinksTest cthis){
    ...
    clRteAsynSigs.get(clRteAsynSigs.self, sig_get_CpnSinksTest_wOutput, (uint8*)&storeData.data, sizeof(float32));
    storeData.index++;
    clRteAsynSigs.set(clRteAsynSigs.self, sig_set_CpnSinksTest_fetchData, (uint8*)&storeData, sizeof(tStoreData));
