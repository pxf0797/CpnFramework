...
#define SIGNAL_TRIG_MAP_LIST_RTESYN_CPNINFO(_)             \
    ...
    _(sig_trig_CpnInfo_addTask,sig_serv_CpnSch_addTask)    \
    _(sig_trig_CpnInfo_delTask,sig_serv_CpnSch_delTask)    \
    ...
    _(sig_trig_CpnInfo_updateFrame,sig_serv_CpnFrameMatrix_updateFrame) \
    _(sig_trig_CpnInfo_getFrameByte,sig_serv_CpnFrameMatrix_getFrameByte) \
    _(sig_trig_CpnInfo_setFrameByte,sig_serv_CpnFrameMatrix_setFrameByte) \
    _(sig_trig_CpnInfo_set_ulInfoLow,matrixMapSet(ulInfoLow)) \
    _(sig_trig_CpnInfo_set_ulInfoHigh,matrixMapSet(ulInfoHigh)) \
    _(sig_trig_CpnInfo_get_ulInfoLow,matrixMapGet(ulInfoLow)) \
    _(sig_trig_CpnInfo_get_ulInfoHigh,matrixMapGet(ulInfoHigh)) \
    _(sig_trig_CpnInfo_sendFrame,sig_serv_CpnFrameMatrix_sendFrame) \
