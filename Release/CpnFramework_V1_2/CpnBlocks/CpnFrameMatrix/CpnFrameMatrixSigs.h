...
typedef struct{
    ...
    uint16 bit_len;
    uint32* value;
} TS_FRAME_GETSET, *hTS_FRAME_GETSET;
// typedef struct{
//     uint32 id;
//     uint16 bit_start;
//     uint16 bit_len;
...
/*服务--设置索引字节
***********************************************/
void serv_CpnFrameMatrix_set_frame_byte(void *buff);
/*服务--触发发送
***********************************************/
void serv_CpnFrameMatrix_sent_frame(void *buff);
...
#define SIGNAL_SERV_LIST_RTESYN_CPNFRAMEMATRIX(_)          \
    ...
    _(sig_serv_CpnFrameMatrix_set_frame_byte,serv_CpnFrameMatrix_set_frame_byte) \
    _(sig_serv_CpnFrameMatrix_sent_frame,serv_CpnFrameMatrix_sent_frame) \
