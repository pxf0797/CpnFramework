...
/*名称 : CpnSch_addList(hCpnSch cthis)
* 输入 : cthis - CpnSch类指针
* 输出 : 无
* 其他 : CpnSch类功能函数
***********************************************/
...
/*名称 : CpnSch_delList(hCpnSch cthis)
* 输入 : cthis - CpnSch类指针
* 输出 : 无
* 其他 : CpnSch类功能函数
***********************************************/
...
/*名称 : CpnSch_setMonitor(hCpnSch cthis)
* 输入 : cthis - CpnSch类指针
* 输出 : 无
* 其他 : CpnSch类功能函数
***********************************************/
...
/*名称 : CpnSch_getMonitor(hCpnSch cthis)
* 输入 : cthis - CpnSch类指针
* 输出 : 无
* 其他 : CpnSch类功能函数
***********************************************/
...
/*名称 : CpnSch_setStrategy(hCpnSch cthis)
* 输入 : cthis - CpnSch类指针
* 输出 : 无
* 其他 : CpnSch类功能函数
***********************************************/
...
/*名称 : CpnSch_getStrategy(hCpnSch cthis)
* 输入 : cthis - CpnSch类指针
* 输出 : 无
* 其他 : CpnSch类功能函数
***********************************************/
...
/*名称 : CpnSch_getTaskNum(hCpnSch cthis)
* 输入 : cthis - CpnSch类指针
* 输出 : 无
* 其他 : CpnSch类功能函数
***********************************************/
