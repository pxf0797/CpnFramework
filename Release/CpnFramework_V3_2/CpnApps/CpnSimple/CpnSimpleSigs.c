 ...
 **********************************************/
void task_start_event(void){
    // SYN_EVENT(E_ADD(e_slice_sch)); /* slice schedule is added by default. */
    // SYN_EVENT(E_ADD(e_event_task)); /* evnet task is added by default. */
    SYN_EVENT(E_ADD(e_err));
    SYN_EVENT(E_ADD(e_info));

    SYN_EVENT(E_ADD(e_CpnAlarm));
    SYN_EVENT(E_ADD(e_CpnSource));
    SYN_EVENT(E_ADD(e_CpnSinks));
