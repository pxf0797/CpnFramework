...
class CTemplate:
    ...
    __CpnErrCfgHeaderPath = 'CpnErrCfg.h'
    ...
    def generateCpnConfigErrorCode(self):
        ...
        comments += (' **********************************************************/\n')
        comments += ('typedef enum{\n    ERR_%s_FUNC,\n} te%sErrClassify;\n' %(self.__fileName.upper(),self.__fileName))
        comments += ('/* Error code.\n')
        comments += (' **********************************************************/\n')
    ...
    def createSource(self):
        ...
        self.updatefCommentUsedDescription('%s source file.' %self.__fileName)
    ...
    def createHeader(self):
        ...
        self.updatefCommentUsedDescription('%s head file.' %self.__fileName)
