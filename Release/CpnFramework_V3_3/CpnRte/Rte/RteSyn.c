 ...
 **********************************************/
void RteSyn_serv(hRteSyn cthis, synType signal, uint8 *buff){
 ...
 * Others   : RteSyn class function.
 **********************************************/
void RteSyn_trig(hRteSyn cthis, synType signal, uint8 *buff){
 ...
 **********************************************/
hRteSyn RteSyn_init(hRteSyn cthis, void **serv_ServBuff, synType *trig_index){
    /* Configure functions. */
